    ...
    <body>
        <div class="container">
            ...
            <div id="divBody" class="decorate">
                <c:if test="${badInput}">
                You entered bad input. You suck. Go Back.<br><br>
                <a href="${pageContext.request.contextPath}/luckySevens"><input type="submit" value="Restart"/></a>
            </c:if>

            <c:if test="${!badInput}">
                <c:out value="${rollCount}" default= "Oops! Something went wrong!"/> <br>
                <c:out value="${results}" default= "Oops! Something went wrong!"/><br>
                <a href="${pageContext.request.contextPath}/luckySevens"><input type="submit" value="Restart"/></a>
            </c:if>
            </div>
            <footer>
